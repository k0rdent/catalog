            ...
            <div>
              ...
              <div style={{marginBottom:14}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8}}>
                  {[{l:"Total pulls",v:item.pulls>0?fmtNum(item.pulls):"—",c:B.teal},{l:"30-day growth",v:d.trend,c:B.green},{l:"GitHub stars",v:item.stars>0?fmtNum(item.stars):"—",c:B.cyan,href:item.githubRepo?"https://github.com/"+item.githubRepo:""},{l:"Trending",v:d.hot?"Hot right now":"Stable",c:d.hot?B.red:B.textSec}].map(function(r:any){
