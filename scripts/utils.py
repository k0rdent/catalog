...
def get_servicetemplate_install_cmd(repo: str, charts: list) -> str:
    ...
    for chart in charts:
        ...
        cmd_lines.append(f'helm upgrade --install {chart["name"]} {kgst_repo}/kgst \\\n  {repo_args}--set "chart={chart["name"]}:{chart["version"]}" \\\n  -n kcm-system')
    cmd = "\n".join(cmd_lines)
    return cmd
...
def print_test_vars(args):
    ...
    test_remove_multiclusterservice = str(app_data.get('test_remove_multiclusterservice', default)).lower()
...
def version2template_names(version: str) -> dict:
    ...
    mapping = {
        ...
        "v1.9.0": {"adopted_cluster":"adopted-cluster-1-0-2","aws_eks":"aws-eks-1-0-9","aws_hosted_cp":"aws-hosted-cp-1-0-31","aws_standalone_cp":"aws-standalone-cp-1-0-28","azure_aks":"azure-aks-1-0-6","azure_hosted_cp":"azure-hosted-cp-1-0-33","azure_standalone_cp":"azure-standalone-cp-1-0-28","docker_hosted_cp":"docker-hosted-cp-1-0-7","gcp_gke":"gcp-gke-1-0-12","gcp_hosted_cp":"gcp-hosted-cp-1-0-29","gcp_standalone_cp":"gcp-standalone-cp-1-0-25", "kubevirt_hosted_cp":"kubevirt-hosted-cp-1-0-7", "kubevirt_standalone_cp":"kubevirt-standalone-cp-1-0-7", "openstack_hosted_cp":"openstack-hosted-cp-1-0-25", "openstack_standalone_cp":"openstack-standalone-cp-1-0-29", "remote_cluster":"remote-cluster-1-0-25","vsphere_hosted_cp":"vsphere-hosted-cp-1-0-28","vsphere_standalone_cp":"vsphere-standalone-cp-1-0-25"},
        "v1.10.0": {"adopted_cluster":"adopted-cluster-1-0-2","aws_eks":"aws-eks-1-0-10","aws_hosted_cp":"aws-hosted-cp-1-0-36","aws_standalone_cp":"aws-standalone-cp-1-0-34","azure_aks":"azure-aks-1-0-8","azure_hosted_cp":"azure-hosted-cp-1-0-39","azure_standalone_cp":"azure-standalone-cp-1-0-36","docker_hosted_cp":"docker-hosted-cp-1-0-11","gcp_gke":"gcp-gke-1-0-13","gcp_hosted_cp":"gcp-hosted-cp-1-0-34","gcp_standalone_cp":"gcp-standalone-cp-1-0-32","kubevirt_hosted_cp":"kubevirt-hosted-cp-1-0-10","kubevirt_standalone_cp":"kubevirt-standalone-cp-1-0-12","openstack_hosted_cp":"openstack-hosted-cp-1-0-31","openstack_standalone_cp":"openstack-standalone-cp-1-0-37","remote_cluster":"remote-cluster-1-0-29","vsphere_hosted_cp": "vsphere-hosted-cp-1-0-34","vsphere_standalone_cp": "vsphere-standalone-cp-1-0-33"},
        "v1.11.0": {"adopted_cluster":"adopted-cluster-1-0-2","aws_eks":"aws-eks-1-0-13","aws_hosted_cp":"aws-hosted-cp-1-0-43","aws_standalone_cp":"aws-standalone-cp-1-0-41","azure_aks":"azure-aks-1-0-10","azure_hosted_cp":"azure-hosted-cp-1-0-46","azure_standalone_cp":"azure-standalone-cp-1-0-43","docker_hosted_cp":"docker-hosted-cp-1-0-15","gcp_gke":"gcp-gke-1-0-15","gcp_hosted_cp":"gcp-hosted-cp-1-0-43","gcp_standalone_cp":"gcp-standalone-cp-1-0-41","kubevirt_hosted_cp":"kubevirt-hosted-cp-1-0-18","kubevirt_standalone_cp":"kubevirt-standalone-cp-1-0-20","openstack_hosted_cp":"openstack-hosted-cp-1-0-38","openstack_standalone_cp":"openstack-standalone-cp-1-0-44","remote_cluster":"remote-cluster-1-0-36","vsphere_hosted_cp":"vsphere-hosted-cp-1-0-41","vsphere_standalone_cp":"vsphere-standalone-cp-1-0-40"},
    }
